  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header p-3">
        <h5 class="modal-title" id="contractDeleteModalLabel1">حذف العقد : 9408</h5>
      ...
      <div class="modal-body p-3">
        <div class="top-area d-flex align-items-center justify-content-center gap-4 flex-column">
          ...
          <h5 class="d-block text-center fw-medium text-danger m-0">هل أنت متأكد أنك تريد حذف العقد ؟</h5>
        </div><!-- top-area -->
      </div><!-- modal-body -->
