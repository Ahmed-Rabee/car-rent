...
@section('content')
  <div id="contracts-print-page" class="min-vh-100 bg-white d-flex flex-column p-2 mx-auto border">
          ...
          <tr>
            <td width="50%" class="p-1 align-top">
              <div class="d-flex flex-column gap-1">
                <div class="item d-flex align-items-center justify-content-between gap-1">
              ...
              <tr>
                <td class="py-2 px-1 align-top">
                  <div class="d-flex flex-column gap-2">
                    <div class="item-with-dots d-flex align-items-center justify-content-between gap-1">
                    ...
                    <div class="item-with-dots d-flex align-items-center justify-content-between gap-1">
                      <div class="d-block flex-shrink-0">الكيلو متر عند العودة :</div>
                      <b class="d-block flex-grow-1 align-self-stretch position-relative">
                        <b class="d-block flex-grow-1" dir="ltr"></b>
                      </b>
                    </div><!-- item-with-dots -->
          ...
          <table class="table table-bordered h-100">
            <tbody>
              <tr>
                <td class="p-1 align-top">
                  <div class="d-flex flex-column gap-2">
                    <div class="item d-flex align-items-start justify-content-between gap-1">
              ...
              <tr>
                <td width="50%" class="p-1 align-middle">
                  <div class="imgthumb d-flex align-items-center justify-content-center">
                    <img src="{{ asset('assets/images/car-drow.png') }}" alt="Car" class="img-fluid">
                  </div><!-- imgthumb -->
                </td>
              </tr>
            </tbody>
