      ...
      <div class="table-responsive text-nowrap">
        <table class="table table-striped table-hover">
          ...
          <tbody class="table-border-bottom-0">
            <tr>
              <td>
                <a href="{{ url('/calculations/incomes/{id}/view') }}">بيع سيارة مستعمله</a>
              </td>
              <td>بيع</td>
              <td>فرع الواحة</td>
              <td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item waves-effect" href="{{ url('/calculations/incomes/{id}/view') }}"><i class="ti ti-eye me-1"></i> عرض</a>
                    <a class="dropdown-item waves-effect" href="{{ url('/calculations/incomes/{id}/edit') }}"><i class="ti ti-pencil me-1"></i> تعديل</a>
                    <a class="dropdown-item waves-effect" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#incomesDeleteModal"><i class="ti ti-trash me-1"></i> حذف</a>
                  </div>
                </div>
              </td>
            </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body p-3">
            <div class="top-area d-flex align-items-center justify-content-center gap-4 flex-column">
              ...
              <h5 class="d-block text-center fw-medium text-danger m-0">هل أنت متأكد أنك تريد حذف الإيراد ؟</h5>
            </div><!-- top-area -->
          </div><!-- modal-body -->
