...
@section('content')
  <div id="origins-index-page">

    <h4 class="mb-3">الأصول</h4>

    <div class="tabs-area d-flex align-items-center justify-content-start gap-3 flex-wrap mb-3">
      <div class="btn btn-primary waves-effect waves-light">الأصول</div>
      <a href="{{ url('/calculations/origins/categories') }}" class="btn btn-label-dark waves-effect">أقسام الأصول</a>
    </div><!-- tabs-area -->
    ...
    <div class="d-flex flex-wrap gap-3 justify-content-between align-items-start align-items-md-center mb-3">
      ...
      <div class="d-flex align-content-center flex-wrap gap-3 flex-shrink-0">
        <a href="{{ url('/calculations/origins/create') }}" class="btn btn-primary waves-effect waves-light"><span class="ti-xs ti ti-plus me-2"></span> إضافة أصل جديد</a>
      </div><!-- d-flex -->
    </div><!-- d-flex -->
        ...
        <table class="table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th class="fw-bold">معدل الإهلاك</th>
          ...
          <tbody class="table-border-bottom-0">
            <tr>
              <td>
                <a href="{{ url('/calculations/origins/{id}/view') }}">هاتف لوحي ايفون</a>
              </td>
              <td>اجهزة اتصالات</td>
              <td>فرع الواحة</td>
              <td>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item waves-effect" href="{{ url('/calculations/origins/{id}/view') }}"><i class="ti ti-eye me-1"></i> عرض</a>
                    <a class="dropdown-item waves-effect" href="{{ url('/calculations/origins/{id}/edit') }}"><i class="ti ti-pencil me-1"></i> تعديل</a>
                    <a class="dropdown-item waves-effect" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#originsDeleteModal"><i class="ti ti-trash me-1"></i> حذف</a>
                  </div>
                </div>
              </td>
            </tr>
