...
@section('content')
  <div id="general-expenses-create-page">
    ...
    <h4 class="mb-3">تعديل مصروف عام : ورق للطابعه</h4>

    <a href="{{ url('/calculations/general-expenses/{id}/view') }}" class="btn btn-icon bg-white text-body waves-effect waves-light mb-3"><span class="ti ti-chevron-right"></span></a>
