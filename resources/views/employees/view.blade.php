            ...
            <div class="user-avatar-section">
              <div class="d-flex align-items-center flex-column">
                ...
                <div class="user-info text-center">
                  <h5 class="mb-3">احمد محمد محمود</h5>
                  <span class="badge bg-label-secondary py-2 mt-1">موظف إستقبال</span>
                </div><!-- user-info -->
              </div><!-- d-flex -->
              <hr class="my-3">
              <ul class="d-flex flex-column gap-3 m-0 p-0">
                <li class="d-flex align-items-center justify-content-start gap-1 flex-wrap">
                ...
                <li class="d-flex align-items-center justify-content-start gap-1 flex-wrap">
                  ...
                  <span class="d-block flex-grow-1">
                    <a href="mailto:vafgot@vultukir.org" target="_blank" dir="ltr">vafgot@vultukir.org
                    </a>
                  </span>
                </li>
                <li class="d-flex align-items-center justify-content-start gap-1 flex-wrap">
