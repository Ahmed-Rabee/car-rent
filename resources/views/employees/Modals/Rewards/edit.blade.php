<div class="modal fade" id="rewardEditModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header p-3">
        <h5 class="modal-title" id="rewardEditModalLabel1">تعديل مكافآة : احمد محمد محمود</h5>
      ...
      <div class="modal-body p-3">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-sm-9">
            <select id="employee-name-2" class="select2 form-select" data-allow-clear="false" data-placeholder="" data-dropdown-parent="#rewardEditModal">
              <option></option>
